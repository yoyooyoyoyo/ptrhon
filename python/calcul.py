...
entry = tk.Entry(upper_frame, width=20, font=("Courier",18), borderwidth=5, bg='pink')
entry.pack()
entry.insert(0,"")
...
btn_mul= tk.Button(down_frame,text='X', padx=15, pady=10, font=("Courier",15),command=button_mul, bg="yellow")
